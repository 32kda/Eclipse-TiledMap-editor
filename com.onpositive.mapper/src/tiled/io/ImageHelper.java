...
public class ImageHelper
{
    ...
    static public org.eclipse.swt.graphics.Image bytesToSWTImage(byte[] imageData) throws IOException {
        return new org.eclipse.swt.graphics.Image(Display.getDefault(),new ByteArrayInputStream(imageData));
    }
